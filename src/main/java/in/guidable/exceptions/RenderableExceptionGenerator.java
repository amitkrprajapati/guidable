...
public class RenderableExceptionGenerator {
    ...
    public static RenderableException generateEntityNotFoundOrNotAuthorizedException(String resourceName, String resourceId)
    {
        String message = String.format("%s with id %s, not found or not authorized", resourceName, resourceId);
